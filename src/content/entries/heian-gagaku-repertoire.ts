...
The Heian court tracked this music in detail. Treatises such as the *Taigensho* (compiled later, in 1512, by Toyohara Sumiaki, but drawing on earlier materials) catalogue gagaku pieces with notes on their origin, composer (often a specific named Tang or Korean master), mode, tempo category, dance affiliation, and circumstances of performance. Manuscript notations for individual instruments, particularly the *biwa* (lute) and *ryuteki* (flute) parts, were kept in family libraries of the hereditary music lineages (the Toyohara, Oga, and Ono among others), with some fascicles copied into the imperial collection.
